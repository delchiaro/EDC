...
FCT_BGN()
{
    FCT_SUITE_BGN(test_suite_rsa)
    {
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_1_sha512_1536_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_SHA512, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_2_sha256_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_SHA256, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_3_sha224_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_SHA224, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_4_sha384_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_SHA384, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_5_md2_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_MD2, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_6_md4_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_MD4, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_7_md5_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_MD5, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_raw_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_RAW, hash_len, hash_result, output ) == 0 );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_9_invalid_digest_type)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, 1, 0, hash_result, output ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_invalid_padding_type)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, RSA_PRIVATE, SIG_RSA_MD5, 0, hash_result, output ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        ...
        FCT_TEST_BGN(rsa_pkcs1_encrypt_1)
        {
            ...
            fct_chk( rsa_pkcs1_encrypt( &ctx, RSA_PUBLIC, msg_len, message_str, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_encrypt_2_data_too_large)
        {
            ...
            fct_chk( rsa_pkcs1_encrypt( &ctx, RSA_PUBLIC, msg_len, message_str, output ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
            if( POLARSSL_ERR_RSA_BAD_INPUT_DATA == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_encrypt_3_invalid_padding_mode)
        {
            ...
            fct_chk( rsa_pkcs1_encrypt( &ctx, RSA_PUBLIC, msg_len, message_str, output ) == POLARSSL_ERR_RSA_INVALID_PADDING );
            if( POLARSSL_ERR_RSA_INVALID_PADDING == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_generate_key)
        {
            ...
            fct_chk( rsa_gen_key( &ctx, 128, 3 ) == 0 );
            if( 0 == 0 )
            {
                fct_chk( rsa_check_privkey( &ctx ) == 0 );
            }
        ...
        FCT_TEST_BGN(rsa_generate_key_number_of_bits_too_small)
        {
            ...
            fct_chk( rsa_gen_key( &ctx, 127, 3 ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
            if( POLARSSL_ERR_RSA_BAD_INPUT_DATA == 0 )
            {
                fct_chk( rsa_check_privkey( &ctx ) == 0 );
            }
        ...
        FCT_TEST_BGN(rsa_generate_key_exponent_too_small)
        {
            ...
            fct_chk( rsa_gen_key( &ctx, 128, 2 ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
            if( POLARSSL_ERR_RSA_BAD_INPUT_DATA == 0 )
            {
                fct_chk( rsa_check_privkey( &ctx ) == 0 );
            }
        ...
        FCT_TEST_BGN(rsa_generate_key)
        {
            ...
            fct_chk( rsa_gen_key( &ctx, 1024, 3 ) == 0 );
            if( 0 == 0 )
            {
                fct_chk( rsa_check_privkey( &ctx ) == 0 );
            }
